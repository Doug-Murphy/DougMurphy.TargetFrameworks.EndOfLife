...
namespace DougMurphy.TargetFrameworks.EndOfLife.Helpers {
	...
	public static class TargetFrameworkEndOfLifeHelper {
		...
		private static readonly Dictionary<string, DateTime?> TargetFrameworksWithEndOfLifeDate = new() {
			...
			{"net11", new DateTime(2011, 07, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"v1.1", new DateTime(2011, 07, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net20", new DateTime(2011, 07, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"v2.0", new DateTime(2011, 07, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net30", new DateTime(2011, 07, 12, 0, 0, 0, DateTimeKind.Utc)}, //net30 is not shown on Microsoft's exhaustive list of TFMs, so this TFM is assumed
			{"v3.0", new DateTime(2011, 07, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net35", new DateTime(2029, 01, 09, 0, 0, 0, DateTimeKind.Utc)},
			{"v3.5", new DateTime(2029, 01, 09, 0, 0, 0, DateTimeKind.Utc)},
			{"net40", new DateTime(2016, 01, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"v4.0", new DateTime(2016, 01, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net403", new DateTime(2016, 01, 12, 0, 0, 0, DateTimeKind.Utc)}, //assumption to match 4.0 and 4.5
			{"v4.0.3", new DateTime(2016, 01, 12, 0, 0, 0, DateTimeKind.Utc)}, //assumption to match 4.0 and 4.5
			{"net45", new DateTime(2016, 01, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"v4.5", new DateTime(2016, 01, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net451", new DateTime(2016, 01, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"v4.5.1", new DateTime(2016, 01, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net452", new DateTime(2022, 04, 26, 0, 0, 0, DateTimeKind.Utc)},
			{"v4.5.2", new DateTime(2022, 04, 26, 0, 0, 0, DateTimeKind.Utc)},
			{"net46", new DateTime(2022, 04, 26, 0, 0, 0, DateTimeKind.Utc)},
			{"v4.6", new DateTime(2022, 04, 26, 0, 0, 0, DateTimeKind.Utc)},
			{"net461", new DateTime(2022, 04, 26, 0, 0, 0, DateTimeKind.Utc)},
			{"v4.6.1", new DateTime(2022, 04, 26, 0, 0, 0, DateTimeKind.Utc)},
			{"net462", new DateTime(2027, 01, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"v4.6.2", new DateTime(2027, 01, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net47", null},
			{"v4.7", null},
			{"net471", null},
			{"v4.7.1", null},
			...
			{"netcoreapp1.0", new DateTime(2019, 06, 27, 0, 0, 0, DateTimeKind.Utc)},
			{"netcoreapp1.1", new DateTime(2019, 06, 27, 0, 0, 0, DateTimeKind.Utc)},
			{"netcoreapp2.0", new DateTime(2018, 10, 01, 0, 0, 0, DateTimeKind.Utc)},
			{"netcoreapp2.1", new DateTime(2021, 08, 21, 0, 0, 0, DateTimeKind.Utc)},
			{"netcoreapp2.2", new DateTime(2019, 12, 23, 0, 0, 0, DateTimeKind.Utc)},
			{"netcoreapp3.0", new DateTime(2020, 03, 03, 0, 0, 0, DateTimeKind.Utc)},
			{"netcoreapp3.1", new DateTime(2022, 12, 13, 0, 0, 0, DateTimeKind.Utc)},

			//.NET 5 TFMs taken from https://github.com/dotnet/designs/blob/main/accepted/2020/net5/net5.md
			{"net5.0", new DateTime(2022, 05, 10, 0, 0, 0, DateTimeKind.Utc)},
			{"net5.0-android", new DateTime(2022, 05, 10, 0, 0, 0, DateTimeKind.Utc)},
			{"net5.0-ios", new DateTime(2022, 05, 10, 0, 0, 0, DateTimeKind.Utc)},
			{"net5.0-macos", new DateTime(2022, 05, 10, 0, 0, 0, DateTimeKind.Utc)},
			{"net5.0-tvos", new DateTime(2022, 05, 10, 0, 0, 0, DateTimeKind.Utc)},
			{"net5.0-watchos", new DateTime(2022, 05, 10, 0, 0, 0, DateTimeKind.Utc)},
			{"net5.0-windows", new DateTime(2022, 05, 10, 0, 0, 0, DateTimeKind.Utc)},
			...
			{"net6.0-android", new DateTime(2024, 11, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net6.0-ios", new DateTime(2024, 11, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net6.0-macos", new DateTime(2024, 11, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net6.0-maccatalyst", new DateTime(2024, 11, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net6.0-tizen", new DateTime(2024, 11, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net6.0-tvos", new DateTime(2024, 11, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net6.0-windows", new DateTime(2024, 11, 12, 0, 0, 0, DateTimeKind.Utc)},

			//.NET 7 TFMs taken from https://learn.microsoft.com/en-us/dotnet/standard/frameworks#net-5-os-specific-tfms
			{"net7.0", new DateTime(2024, 05, 14, 0, 0, 0, DateTimeKind.Utc)},
			{"net7.0-android", new DateTime(2024, 05, 14, 0, 0, 0, DateTimeKind.Utc)},
			{"net7.0-ios", new DateTime(2024, 05, 14, 0, 0, 0, DateTimeKind.Utc)},
			{"net7.0-macos", new DateTime(2024, 05, 14, 0, 0, 0, DateTimeKind.Utc)},
			{"net7.0-maccatalyst", new DateTime(2024, 05, 14, 0, 0, 0, DateTimeKind.Utc)},
			{"net7.0-tvos", new DateTime(2024, 05, 14, 0, 0, 0, DateTimeKind.Utc)},
			{"net7.0-windows", new DateTime(2024, 05, 14, 0, 0, 0, DateTimeKind.Utc)},

			//.NET 8 TFMs taken from https://learn.microsoft.com/en-us/dotnet/standard/frameworks#net-5-os-specific-tfms
			{"net8.0", new DateTime(2026, 11, 10, 0, 0, 0, DateTimeKind.Utc)},
			{"net8.0-android", new DateTime(2026, 11, 10, 0, 0, 0, DateTimeKind.Utc)},
			{"net8.0-browser", new DateTime(2026, 11, 10, 0, 0, 0, DateTimeKind.Utc)},
			{"net8.0-ios", new DateTime(2026, 11, 10, 0, 0, 0, DateTimeKind.Utc)},
			{"net8.0-macos", new DateTime(2026, 11, 10, 0, 0, 0, DateTimeKind.Utc)},
			{"net8.0-maccatalyst", new DateTime(2026, 11, 10, 0, 0, 0, DateTimeKind.Utc)},
			{"net8.0-tizen", new DateTime(2026, 11, 10, 0, 0, 0, DateTimeKind.Utc)},
			{"net8.0-tvos", new DateTime(2026, 11, 10, 0, 0, 0, DateTimeKind.Utc)},
			{"net8.0-windows", new DateTime(2026, 11, 10, 0, 0, 0, DateTimeKind.Utc)},

			//.NET 9 TFMs taken from https://learn.microsoft.com/en-us/dotnet/standard/frameworks#net-5-os-specific-tfms
			{"net9.0", new DateTime(2026, 05, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net9.0-android", new DateTime(2026, 05, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net9.0-browser", new DateTime(2026, 05, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net9.0-ios", new DateTime(2026, 05, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net9.0-macos", new DateTime(2026, 05, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net9.0-maccatalyst", new DateTime(2026, 05, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net9.0-tizen", new DateTime(2026, 05, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net9.0-tvos", new DateTime(2026, 05, 12, 0, 0, 0, DateTimeKind.Utc)},
			{"net9.0-windows", new DateTime(2026, 05, 12, 0, 0, 0, DateTimeKind.Utc)},
		};
